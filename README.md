...
- 업무 내용 : 가축질별 방생의 사전예방 및 질병 발생시 확산 방지를 위해 최신 정보통신(ICT)기술을 활용하여 동물질병 및 가축방역 정보 통합관리.
...
- 회사 : ITPOP
- 개발 기술 : Android
- 업무 내용 : 현대라이브 생명보험 모바일 전자청약 사내 앱 개발.

## 동부화재 모바일 전자청약 연계서버 개발
- 회사 : ITPOP
- 개발 기술 : Java
- 업무 내용 : 동부화재 에서 사용되고 있는 코볼전문 통신 연계작업.

## LG하이프라자 모바일 상품구매
- 회사 : ITPOP
- 개발 기술 : Java
- 업무 내용 : 태블릿과 LGBest 시스템간에 인터페이스 서버 개발
<br />
